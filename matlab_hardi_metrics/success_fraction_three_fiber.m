...
function [final_output] = success_fraction_three_fiber(fa,peaks_gold,peaks_test,tolerance)
                ...
                if (AAA(x,y,z,1) == 0)
                    ...
                    if (AAA(x,y,z,3) == 3)
                        ...
                        if (AAA(x,y,z,3) == BBB(x,y,z,3))
                            ...
                            % Fiber 3
                            m = [AAA(x,y,z,23) AAA(x,y,z,24) AAA(x,y,z,25)];
                            n = [BBB(x,y,z,23) BBB(x,y,z,24) BBB(x,y,z,25)];
                            angle3 = atan2d(norm(cross(m,n)),dot(m,n));
                            if (angle3 > 90)
                                angle3 = 180 - angle3;
                            end
