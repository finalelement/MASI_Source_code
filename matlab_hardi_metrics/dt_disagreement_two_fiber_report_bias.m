...
function dt_disagreement_two_fiber_report_bias
    fa_file = '501_gold_fa.nii';
    [gold_min,gold_max,gold_mean] = dt_disagreement_two_fiber(fa_file,'501_gold_dteig.Bdouble','501_gold_peaks.Bdouble');
    ...
    title('Bias Plot 2 Fiber DT Disagreement - 12 samples');
