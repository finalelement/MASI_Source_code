...
function dt_disagreement_three_fiber_report_bias
    fa_file = '501_gold_fa.nii';
    [gold_min,gold_max,gold_mean] = dt_disagreement_three_fiber(fa_file,'501_gold_dteig.Bdouble','501_gold_peaks.Bdouble');
    ...
    for i = 1:12
        ...
        [variable.(my_field_1),variable.(my_field_2),variable.(my_field_3)] = dt_disagreement_three_fiber(fa_file,dt_file,peaks_file);
    ...
    title('Bias Plot 3 Fiber DT Disagreement - 12 samples (Error Symmetrized)');
