function dt_disagreement_one_fiber_report_mse

    fa_file = '501_gold_fa.nii';
    [gold_min,gold_max,gold_mean] = dt_disagreement_single_fiber(fa_file,'501_gold_dteig.Bdouble','501_gold_peaks.Bdouble');
    ...
    title('MSE Plot 1 Fiber DT Disagreement');
