function plot_2dhist_cross_angle_two_fiber_gold
    ...
    peaks_file = sprintf('501_gold_peaks.Bdouble');
    accum_angles = min_cross_angle_three_fibers_2dhist(fa_file,peaks_file);
    ...
    title('Three Fiber Case:Angle of Separation & Intensity Map (Gold Sample)');
    grid on
    view(3);
