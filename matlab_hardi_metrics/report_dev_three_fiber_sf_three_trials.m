function report_dev_three_fiber_sf_three_trials
    ...
    for i = 1:12
        ...
        [variable.(my_field_1)] = success_fraction_three_fiber(fa_file,gold_file,peaks_file,5);
    ...
    for i = 1:12
        ...
        [variable.(my_field_1)] = success_fraction_three_fiber(fa_file,gold_file,peaks_file,10);
    ...
    for i = 1:12
        ...
        [variable.(my_field_1)] = success_fraction_three_fiber(fa_file,gold_file,peaks_file,15);
    ...
    title('SF 3 Fiber case for 12 samples');
