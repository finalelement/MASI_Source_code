function out = report_dev_sf_number_peaks_three_fiber
    overall_output = [];
    for i = 1:11
        fa_file = 'gold_fa.nii';
        ...
        [variable.(my_field_1)] = sf_number_peaks_three(fa_file,gold_file,peaks_file);
    ...
    a1 = errorbar(sf_mean_matrix(:,1),sf_mean_matrix(:,2),sf_std_matrix(:,2),'linewidth',1.5); M1 = sprintf('No. of peaks - 3');
    ...
    legend([a1],M1);
    title('Success Fraction for Three fiber case for 11 samples');
