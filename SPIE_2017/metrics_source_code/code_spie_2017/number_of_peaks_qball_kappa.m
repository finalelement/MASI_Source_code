function number_of_peaks_qball_kappa(number_of_fibers)
    ...
    % 5 is the number of categories here for the number of peaks 0,1,2,3,4
    kappa_feed = zeros(dims(1),3);
    for j = 1:dims(1)
       ...
       kappa_feed(j,1:3) = [count_1 count_2 count_3];
