function out = cross_angle_two_fiber_report_mse
    
    fa_file = 'gold_fa.nii';
    [gold_min,gold_max,gold_mean] = min_cross_angle_two_fibers(fa_file,'gold_peaks.Bdouble');
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2),variable.(my_field_3)] = min_cross_angle_two_fibers(fa_file,peaks_file);
