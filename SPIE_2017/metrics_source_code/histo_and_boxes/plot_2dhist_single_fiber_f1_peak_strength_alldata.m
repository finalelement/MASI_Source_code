function out = plot_2dhist_single_fiber_f1_peak_strength_alldata
    ...
    for i = 1:11
        ...
        [variable.(my_field_1)] = peak_strength_f1_one_fiber_2dhist(fa_file,peaks_file);
    ...
    title('Single Fiber Case:Peak Strength f1, 12 samples & Intensity Map');
    grid on
    view(3);
