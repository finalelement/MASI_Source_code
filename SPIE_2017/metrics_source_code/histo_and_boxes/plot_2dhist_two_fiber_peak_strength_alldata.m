function plot_2dhist_two_fiber_peak_strength_alldata
    ...
    for i = 1:12
        ...
        [variable.(my_field_1)] = peak_strength_f1_two_fibers_2dhist(fa_file,peaks_file);
    ...
    title('Two Fiber Case:Peak Strength f1, 12 samples & Intensity Map');
    grid on
    view(3);
