...
function out = peak_to_peak_single_fiber_error_box_report_deviation
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2)] = peak_to_peak_error_method2strength_single_fiber(fa_file,peaks_gold,peaks_file);
