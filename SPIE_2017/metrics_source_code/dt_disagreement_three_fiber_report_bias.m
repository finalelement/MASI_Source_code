...
function out = dt_disagreement_three_fiber_report_bias
    fa_file = 'gold_fa.nii';
    [gold_min,gold_max,gold_mean] = dt_disagreement_three_fiber(fa_file,'gold_dteig.Bdouble','gold_peaks.Bdouble');
