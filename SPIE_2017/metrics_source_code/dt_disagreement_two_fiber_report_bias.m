...
function out = dt_disagreement_two_fiber_report_bias
    fa_file = 'gold_fa.nii';
    [gold_min,gold_max,gold_mean] = dt_disagreement_two_fiber(fa_file,'gold_dteig.Bdouble','gold_peaks.Bdouble');
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2),variable.(my_field_3)] = dt_disagreement_two_fiber(fa_file,dt_file,peaks_file);
    ...
    title('Two Fiber Case: Bias Plot DT Disagreement - 11 samples');
