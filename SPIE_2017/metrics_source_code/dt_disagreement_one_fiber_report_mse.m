function out = dt_disagreement_one_fiber_report_mse

    fa_file = 'gold_fa.nii';
    [gold_min,gold_max,gold_mean] = dt_disagreement_single_fiber(fa_file,'gold_dteig.Bdouble','gold_peaks.Bdouble');
