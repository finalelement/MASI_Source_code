function [min_output,max_output,mean_output] = dt_disagreement_two_fiber(fa,dt_file,peaks_file,mask)
                ...
                if (AAA(x,y,z,1) == 0)
                    ...
                    if(mask_mask.img(x,y,z) == 1)
                        ...
                        if (AAA(x,y,z,3) == 2)
                            ...
                            %if (angle_error2 < angle_error1)
                            %    angle_error = angle_error2;
                            %else
                            %    angle_error = angle_error1;
                            %end

                            % Symmetrizing the error angles
