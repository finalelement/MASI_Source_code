...
function out = dt_disagreement_two_fiber_box_report_deviation(mask)
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2)] = dt_disagreement_two_fiber_box(fa_file,dt_file,peaks_file,mask);
    ...
    title('PAS Disagreement w DT 2 Fiber case - 11 samples');
