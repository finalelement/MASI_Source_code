...
function out = dt_disagreement_second_order_two_fiber_box_report_deviation(mask)
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2)] = dt_disagreement_second_order_two_fibers(fa_file,dt_file,peaks_file,mask);
