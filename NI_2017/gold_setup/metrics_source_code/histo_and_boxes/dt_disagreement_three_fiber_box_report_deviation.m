...
function out = dt_disagreement_three_fiber_box_report_deviation(mask)
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2)] = dt_disagreement_three_fiber_box(fa_file,dt_file,peaks_file,mask);
    ...
    title('PAS Disagreement w DT 3 Fiber case - 11 samples');
