function peak_disagreement_two_fiber_box_report_deviation
    ...
    for i = 1:12
        ...
        [variable.(my_field_1),variable.(my_field_2)] = peak_to_peak_disagreement_two_fiber(fa_file,peaks_gold,peaks_test);
    ...
    title('PAS Error w Gold PAS 2 Fiber case across 12 samples (Error Symmetrized)');
