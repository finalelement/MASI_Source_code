...
function [test_output] = peak_strength_f2_three_fibers_2dhist(fa,peaks_file,mask)
    ...
    title('Three Fiber Case:Peak Strength f2, Gold sample & Intensity Map');
    grid on
    view(3);
