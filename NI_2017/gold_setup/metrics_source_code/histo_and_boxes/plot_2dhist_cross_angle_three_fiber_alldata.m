function out = plot_2dhist_cross_angle_three_fiber_alldata(mask)
    ...
    for i = 1:11
        ...
        [variable.(my_field_1)] = min_cross_angle_three_fibers_2dhist(fa_file,peaks_file,mask);
    ...
    title('Three Fiber Case:Angle of Separation 11 samples & Intensity Map');
    grid on
    view(3);
