% Peak strength of first fiber in three fiber case. The peak strengths have
% been normalized

function [test_output] = peak_strength_f1_three_fibers_2dhist(fa,peaks_file,mask)
    ...
    title('Three Fiber Case:Peak Strength f1, Gold sample & Intensity Map');
    grid on
    view(3);
