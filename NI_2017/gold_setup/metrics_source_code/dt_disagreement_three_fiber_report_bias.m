...
function out = dt_disagreement_three_fiber_report_bias(mask)
    fa_file = 'gold_fa.nii';
    [gold_min,gold_max,gold_mean] = dt_disagreement_three_fiber(fa_file,'gold_dteig.Bdouble','gold_peaks.Bdouble',mask);
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2),variable.(my_field_3)] = dt_disagreement_three_fiber(fa_file,dt_file,peaks_file,mask);
    ...
    title('Three Fiber Case: Bias Plot DT Disagreement - 11 samples');
