...
function [sf_mean_matrix,sf_std_matrix] = report_dev_two_fiber_sf_three_trials(mask)
    %{
    overall_output = [];
    for i = 1:10
        ...
        [variable.(my_field_1)] = success_fraction_two_fiber(fa_file,gold_file,peaks_file,5,rois,rois_region);
    ...
    for i = 1:10
        ...
        [variable.(my_field_1)] = success_fraction_two_fiber(fa_file,gold_file,peaks_file,20,rois,rois_region);
    ...
    a2 = errorbar(sf_mean_matrix(:,1),sf_mean_matrix(:,2),sf_std_matrix(:,2),'linewidth',1.5); M2 = 'tolerance-20';
    %}
    ...
    for i = 1:11
        ...
        [variable.(my_field_1)] = success_fraction_two_fiber(fa_file,gold_file,peaks_file,20,mask);
    ...
    t1 = text(sf_mean_matrix(:,1),sf_mean_matrix(:,2),num2str(variable.A2(:,3)),'Color','red');
