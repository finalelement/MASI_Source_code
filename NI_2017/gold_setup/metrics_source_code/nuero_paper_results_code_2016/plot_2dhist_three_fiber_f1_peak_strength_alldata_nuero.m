function [out,n1] = plot_2dhist_three_fiber_f1_peak_strength_alldata_nuero(mask)
    ...
    for i = 1:11
        ...
        [variable.(my_field_1)] = peak_strength_f1_three_fibers_2dhist(fa_file,peaks_file,mask);
    ...
    title('Three Fiber Case:Peak Strength f1, 11 samples & Intensity Map');
    grid on
    view(3);
