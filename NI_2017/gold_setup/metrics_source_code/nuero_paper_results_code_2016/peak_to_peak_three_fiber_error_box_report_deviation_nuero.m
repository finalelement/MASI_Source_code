...
function [mean_mean_matrix,mean_std_matrix] = peak_to_peak_three_fiber_error_box_report_deviation_nuero(mask)
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2)] = peak_to_peak_error_method2strength_three_fiber(fa_file,peaks_gold,peaks_file,mask);
