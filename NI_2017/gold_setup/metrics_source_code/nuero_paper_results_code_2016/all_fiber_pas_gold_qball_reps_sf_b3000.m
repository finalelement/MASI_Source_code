function all_fiber_pas_gold_qball_reps_sf_b3000
    ...
    title('SF Single Fiber Peaks Gold PAS & Q-ball reps at b-value 3000');
    ...
    file_name = sprintf('pas_gold_qball_reps_b3000');
