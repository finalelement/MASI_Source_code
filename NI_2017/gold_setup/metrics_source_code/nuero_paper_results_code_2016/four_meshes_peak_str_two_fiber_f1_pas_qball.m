function four_meshes_peak_str_two_fiber_f1_pas_qball
    ...
    subplot(1,4,1)
    grid on
    [out1,n11] = plot_2dhist_two_fiber_f1_peak_strength_alldata_nuero(mask);
    %view([-40 90]);
    ylabel('f1');
    ...
    subplot(1,4,2)
    grid on
    [out2,n22] = plot_2dhist_two_fiber_f1_peak_strength_alldata_nuero(mask);
    %view([-40 90]);
    ylabel('f1');
    xlabel('Fractional Anisotropy');
    title('Qball-b1000')
    ...
    subplot(1,4,3)
    grid on
    [out3,n33] = plot_2dhist_two_fiber_f1_peak_strength_alldata_nuero(mask);
    %view([-40 90]);
    ylabel('f1');
    xlabel('Fractional Anisotropy');
    title('PAS-b3000')
    ...
    subplot(1,4,4)
    grid on
    [out4,n44] = plot_2dhist_two_fiber_f1_peak_strength_alldata_nuero(mask);
    %view([-40 90]);
    ylabel('f1');
    xlabel('Fractional Anisotropy');
    title('Qball-b3000')
    ...
    file_name = sprintf('two_fiber_peak_strength_f1');
