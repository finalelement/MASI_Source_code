function sf_three_fiber_pas_qball_b1000_b3000
    ...
    [sf_mean_matrix2,sf_std_matrix2] = report_dev_three_fiber_sf_three_trials(mask);
    ...
    [sf_mean_matrix4,sf_std_matrix4] = report_dev_three_fiber_sf_three_trials(mask);
    ...
    file_name = sprintf('three_fiber_sf');
