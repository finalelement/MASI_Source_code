function [sf_mean_matrix,sf_std_matrix,spatial_data] = report_dev_single_fiber_sf_three_trials_spatial(mask)
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2)] = success_fraction_one_fiber_spatial(fa_file,gold_file,peaks_file,20,mask);
