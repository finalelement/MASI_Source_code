function spatial_map_gold_pas_qball_reps_agreement_b1000
    ...
    file_name = sprintf('single_fiber_spatial_pas_gold_b1000');
    ...
    fig = gcf;
    fig.PaperPositionMode = 'auto';
    file_name = sprintf('two_fiber_spatial_pas_gold_b1000');
    print(file_name,'-depsc2','-r0')
    ...
    fig = gcf;
    fig.PaperPositionMode = 'auto';
    file_name = sprintf('three_fiber_spatial_pas_gold_b1000');
    print(file_name,'-depsc2','-r0')
