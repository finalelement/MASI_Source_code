function spatial_map_gold_qball_pas_reps_agreement_b3000

    mask = 'WM_nuero_mask.nii'; 
    title('Spatial map, Qball gold and PAS reps');
    addpath(genpath('/fs4/masi/nathv/NueroImage_2016_Code/organized_normalized_data_for_runnable_code/b3000/Qball_gold_PAS_reps'))
    ...
    file_name = sprintf('single_fiber_spatial_qball_gold_b3000');
    ...
    fig = gcf;
    fig.PaperPositionMode = 'auto';
    file_name = sprintf('two_fiber_spatial_qball_gold_b3000');
    print(file_name,'-depsc2','-r0')
    ...
    fig = gcf;
    fig.PaperPositionMode = 'auto';
    file_name = sprintf('three_fiber_spatial_qball_gold_b3000');
    print(file_name,'-depsc2','-r0')

    rmpath(genpath('/fs4/masi/nathv/NueroImage_2016_Code/organized_normalized_data_for_runnable_code/b3000/Qball_gold_PAS_reps'))
