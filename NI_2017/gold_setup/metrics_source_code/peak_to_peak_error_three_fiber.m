...
function [output,mean_output] = peak_to_peak_error_three_fiber(fa,peaks_gold,peaks_test)
                ...
                if (AAA(x,y,z,1) == 0)
                    ...
                    if (AAA(x,y,z,3) == 3)
                        ...
                        if (BBB(x,y,z,3) == 2)
                            ...
                            normps = [BBB(x,y,z,10)/ps BBB(x,y,z,18)/ps BBB(x,y,z,10)/ps BBB(x,y,z,18)/ps BBB(x,y,z,10)/ps BBB(x,y,z,18)/ps];
                            ...
                            angle_error5 = atan2d(norm(cross(o,j)),dot(o,j));
                            if (angle_error5 > 90)
                                angle_error5 = 180 - angle_error5;
                            end
                            
                            angle_error6 = atan2d(norm(cross(o,k)),dot(o,k));
                            if (angle_error6 > 90)
                        ...
                        if (BBB(x,y,z,3) == 3)
                            ...
                            normps = [BBB(x,y,z,10)/ps BBB(x,y,z,18)/ps BBB(x,y,z,26)/ps BBB(x,y,z,10)/ps BBB(x,y,z,18)/ps BBB(x,y,z,26)/ps BBB(x,y,z,10)/ps BBB(x,y,z,18)/ps BBB(x,y,z,26)/ps]; 
                            ...
                            angy = [angle_error1 angle_error2 angle_error3 angle_error4 angle_error5 angle_error6 angle_error7 angle_error8 angle_error9];
                            angy = angy.*normps;
                            angle_error = sum(angy)/3;
                            row = [frac_val angle_error];
                        end
