function final_output = sf_cross_angle_error_error(fa,peaks_gold,peaks_test)
    ...
    while (temp < while_end_limit)
       ...
       mean_error = mean(truncated_angles(:,3));
       row2 = [angle_val mean_error tc];
