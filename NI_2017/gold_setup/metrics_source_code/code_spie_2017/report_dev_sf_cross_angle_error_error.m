function [sf_mean_matrix,sf_std_matrix,text_values] = report_dev_sf_cross_angle_error_error
    overall_output = [];
    for i = 1:11
        fa_file = 'gold_fa.nii';
        ...
        variable.(my_field_1) = sf_cross_angle_error_error(fa_file,gold_file,peaks_file);
