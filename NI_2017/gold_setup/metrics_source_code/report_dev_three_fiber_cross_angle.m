function report_dev_three_fiber_cross_angle
    ...
    ylabel('Cross Angle b/w PAS fibers','fontweight','demi','fontsize',12);
    legend([a1,a2,a3],M1,M2,M3);
    title('Angle of Separation for Three fiber case - 12 samples');
end