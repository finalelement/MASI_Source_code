function out = cross_angle_three_fiber_report_mse(mask)
    
    fa_file = 'gold_fa.nii';
    [gold_min,gold_max,gold_mean] = min_cross_angle_three_fibers(fa_file,'gold_peaks.Bdouble',mask);
    ...
    for i = 1:11
        ...
        [variable.(my_field_1),variable.(my_field_2),variable.(my_field_3)] = min_cross_angle_three_fibers(fa_file,peaks_file,mask);
    ...
    title('Three Fiber Case: MSE for Angle of Separation - 11 samples');
